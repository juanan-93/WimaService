            ...
            <div class="flex items-center gap-3">
                <div class="relative">
                    <input type="text" id="searchInput" placeholder="Buscar categoría..." 
                        class="w-64 pl-10 pr-4 py-2 bg-background border border-border rounded-lg text-sm text-foreground placeholder-muted-foreground focus:outline-none focus:ring-2 focus:ring-[#1e3a5f] focus:border-transparent">
                    ...
                    <tr class="hover:bg-muted/30 transition-colors" data-id="{{ $category->id }}">
                        ...
                        <td class="px-6 py-4">
                            <div class="flex items-center justify-end gap-2">
                                <button class="p-2 text-muted-foreground hover:text-blue-600 hover:bg-blue-50 rounded-lg transition-colors btn-view" data-id="{{ $category->id }}" title="Ver">
    ...
    <script>
                ...
                <div class="text-left space-y-4">
                    ...
                    <div class="lang-content" data-lang="es">
                        <div class="mb-3">
                            ...
                            <input type="text" id="swal-name_es" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#1e3a5f] focus:border-transparent" value="${category?.name_es || ''}" required>
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Descripción (Castellano)</label>
                            <textarea id="swal-description_es" rows="2" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#1e3a5f] focus:border-transparent">${category?.description_es || ''}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="lang-content hidden" data-lang="ca">
                        <div class="mb-3">
                            ...
                            <input type="text" id="swal-name_ca" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#1e3a5f] focus:border-transparent" value="${category?.name_ca || ''}">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Descripción (Catalán)</label>
                            <textarea id="swal-description_ca" rows="2" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#1e3a5f] focus:border-transparent">${category?.description_ca || ''}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="lang-content hidden" data-lang="en">
                        <div class="mb-3">
                            ...
                            <input type="text" id="swal-name_en" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#1e3a5f] focus:border-transparent" value="${category?.name_en || ''}">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Descripción (Inglés)</label>
                            <textarea id="swal-description_en" rows="2" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#1e3a5f] focus:border-transparent">${category?.description_en || ''}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="lang-content hidden" data-lang="de">
                        <div class="mb-3">
                            ...
                            <input type="text" id="swal-name_de" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#1e3a5f] focus:border-transparent" value="${category?.name_de || ''}">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Descripción (Alemán)</label>
                            <textarea id="swal-description_de" rows="2" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#1e3a5f] focus:border-transparent">${category?.description_de || ''}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="pt-4 border-t border-gray-200">
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="number" id="swal-order" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#1e3a5f] focus:border-transparent" value="${category?.order || 0}">
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-1">Categoría padre</label>
                                <select id="swal-parent_id" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#1e3a5f] focus:border-transparent">
        ...
        function getFormData() {
            return {
                ...
                parent_id: document.getElementById('swal-parent_id').value || null
            };
        }
                ...
                const result = await Swal.fire({
                    ...
                    didOpen: async () => {
                        ...
                        if (category.parent_id) {
                            document.getElementById('swal-parent_id').value = category.parent_id;
                        }
                    },
                    preConfirm: () => {
                        const name_es = document.getElementById('swal-name_es').value;
